...
namespace xxkUI.Form
{
    public partial class frm_SplashScreen : DevExpress.XtraEditors.XtraForm
    {
        ...
        public frm_SplashScreen(string _caption)
            : this(_caption, "", "", 100)
        {
        }
        ...
        public frm_SplashScreen(string _caption,string _message) 
        ...
        public frm_SplashScreen(string _caption, string _message,string _content)
        ...
        public frm_SplashScreen(string _caption, string _message,string _content,int _maxProcess)
            : this()
        {
            this.Caption = "";
            this.Message = "";
